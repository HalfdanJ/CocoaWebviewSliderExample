...
- (void)awakeFromNib
{
    ...
    [[webView windowScriptObject] evaluateWebScript:@"console = { log: function(msg) { AppController.consoleLog_(msg); } }"];
...
+ (BOOL)isSelectorExcludedFromWebScript:(SEL)aSelector
{
    ...
    if (aSelector == @selector(showMessage:) || aSelector == @selector(setChannel:toValue:) || aSelector == @selector(consoleLog:)) {
